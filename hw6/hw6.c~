...
//  Enable textures
   ...
   //  Front
   glColor3f(1,0,0);
   if (ntex) glBindTexture(GL_TEXTURE_2D,texture[6+C_FRONT]);
   glBegin(GL_QUADS);
   glNormal3f( 0, 0, 1);
   if (ntex) {
   ...
   //  Back
   glColor3f(0,0,1);
   if (ntex) glBindTexture(GL_TEXTURE_2D,texture[6+C_BACK]);
   glBegin(GL_QUADS);
   glNormal3f( 0, 0,-1);
   if (ntex) {
     glTexCoord2f(0,.65); glVertex3f(+1,-1,-1);
   ...
   //  Right
   glColor3f(1,1,0);
   if (ntex) glBindTexture(GL_TEXTURE_2D,texture[6+C_RIGHT]);
   glBegin(GL_QUADS);
   glNormal3f(+1, 0, 0);
   if (ntex) {
     glTexCoord2f(0,.1); glVertex3f(+1,-1,+1);
   ...
   //  Left
   glColor3f(0,1,0);
   if (ntex) glBindTexture(GL_TEXTURE_2D,texture[6+C_LEFT]);
   glBegin(GL_QUADS);
   glNormal3f(-1, 0, 0);
   if (ntex) {
     glTexCoord2f(0,.1); glVertex3f(-1,-1,-1);
   ...
   //  Top
   glColor3f(0,1,1);
   if (ntex) glBindTexture(GL_TEXTURE_2D,texture[6+C_TOP]);
   glBegin(GL_QUADS);
   glNormal3f( 0,+1, 0);
   glTexCoord2f(0,0); glVertex3f(-1,+1,+1);
   glTexCoord2f(1,0); glVertex3f(+1,+1,+1);
   ...
   //  Bottom
   glColor3f(1,0,1);
   if (ntex) glBindTexture(GL_TEXTURE_2D,texture[6+C_BOTTOM]);
   glBegin(GL_QUADS);
   glNormal3f( 0,-1, 0);
   glTexCoord2f(-1,0); glVertex3f(-1,-1,-1);
   glTexCoord2f(0,0); glVertex3f(+1,-1,-1);
...
static void ball(double x,double y,double z,double r)
{
   ...
   for (ph=-90;ph<90;ph+=inc)
   {
      ...
      {
	glTexCoord2f(1,0); Vertex(th,ph,0);
	glTexCoord2f(0,0);Vertex(th,ph+inc,0);
      }
      glEnd();
   }
...
int main(int argc,char* argv[])
{
   ...
   //  Load textures
   crate_texture     = LoadTexBMP("crate.bmp");
   ...
   texture[6+C_FRONT]  = LoadTexBMP("mrow.bmp");
   texture[6+C_LEFT]   = texture[6+C_FRONT];
   texture[6+C_BACK]   = texture[6+C_FRONT];
   texture[6+C_RIGHT]  = texture[6+C_FRONT];
   texture[6+C_TOP]    = LoadTexBMP("clawmark.bmp");
   texture[6+C_BOTTOM] = texture[6+C_TOP];
